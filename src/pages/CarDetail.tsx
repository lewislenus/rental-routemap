        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl overflow-hidden">
              <img src={car.image} alt={car.name} className="w-full aspect-[16/9] object-cover" />
            </div>
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">${car.price * 3}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Insurance</span>
                    <span className="font-medium">${car.insurance}/day</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between text-lg">
                    ...
                    <span className="font-bold text-primary">${car.price * 3 + car.insurance * 3 + 25}</span>
                  </div>
                </div>
